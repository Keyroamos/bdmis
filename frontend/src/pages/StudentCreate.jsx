...
const StudentCreate = () => {
    ...
    const handleSubmit = async () => {
        ...
        if (!formData.password1) {
            data.set('password1', 'student123');
            data.set('password2', 'student123');
        } else {
            // If password provided, ensure password2 matches automatically
            data.set('password2', formData.password1);
        }
                        ...
                        <AnimatePresence mode="wait">
                            {step === 1 && (
                                ...
                                >
                                    ...
                                    <div className="md:col-span-2">
                                        <Input type="text" label="Student Password (Optional)" name="password1" value={formData.password1} onChange={handleChange} placeholder="Leave blank for default: student123" />
                                    </div>
                                </motion.div>
                            )}
                                ...
                                >
                                    <div className="bg-blue-50 p-4 rounded-xl border border-blue-100 flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-blue-700 mt-1">A fee of KES 500.00 is required to complete admission.</p>
                                        </div>
                                    </div>
