                        ...
                        {(data.popular_plans || []).length > 0 ? (
                            <div className="h-80">
                                <ResponsiveContainer width="100%" height="100%" minWidth={0}>
                                    <BarChart data={data.popular_plans || []} margin={{ top: 20, right: 30, left: 0, bottom: 60 }}>
                                        <XAxis
                                            dataKey="name"
                                            angle={-45}
                                            textAnchor="end"
                                        ...
                                        <Bar dataKey="value" radius={[8, 8, 0, 0]}>
                                            {(data.popular_plans || []).map((entry, index) => (
                            ...
                            <div className="h-80 flex items-center justify-center text-slate-400">
                                <div className="text-center">
                                    ...
                                    <p className="font-medium">No meal plans data available</p>
                                </div>
                            </div>
                        )}
                    </div>
