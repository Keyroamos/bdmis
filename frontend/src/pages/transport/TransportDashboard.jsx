...
const TransportDashboard = () => {
    ...
    const collectionRate = stats.billed > 0 ? ((stats.collected / stats.billed) * 100).toFixed(1) : 0;
    ...
    const statCards = [
        ...
        },
        {
            ...
            value: `KES ${stats.todays_revenue.toLocaleString()}`,
            icon: TrendingUp,
            trend: 'Live',
            trendUp: true,
                        ...
                        {data.popular_routes.length > 0 ? (
                            <div className="h-80">
                                <ResponsiveContainer width="100%" height="100%" minWidth={0}>
                                    <BarChart data={data.popular_routes} margin={{ top: 20, right: 30, left: 0, bottom: 60 }}>
                                        <XAxis
                                            dataKey="name"
                                            angle={-45}
                                            textAnchor="end"
                                        ...
                                        <Bar dataKey="value" radius={[8, 8, 0, 0]}>
                                            {data.popular_routes.map((entry, index) => (
