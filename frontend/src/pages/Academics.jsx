...
const Academics = () => {
    ...
    return (
        <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-4 md:space-y-8">
            {/* Header Area */}
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 md:gap-6 pb-4 md:pb-6 border-b border-slate-200 dark:border-slate-800">
                <div className="text-center md:text-left">
                    <h1 className="text-2xl md:text-3xl font-black text-slate-900 dark:text-white tracking-tight">Academics</h1>
                    <p className="text-xs md:text-sm text-slate-500 dark:text-slate-400 mt-1 md:mt-2">Manage assessments, record marks, and view analytics.</p>
                </div>
                ...
                <div className="bg-slate-100 dark:bg-slate-800 p-1 rounded-2xl flex items-center w-full md:w-auto">
                    <button
                        ...
                        className={`flex-1 md:flex-none flex items-center justify-center gap-2 px-4 md:px-6 py-2.5 rounded-xl text-xs md:text-sm font-bold transition-all duration-200 ${activeTab === 'record'
                    ...
                    <button
                        ...
                        className={`flex-1 md:flex-none flex items-center justify-center gap-2 px-4 md:px-6 py-2.5 rounded-xl text-xs md:text-sm font-bold transition-all duration-200 ${activeTab === 'reports'
                            ? 'bg-white dark:bg-slate-700 text-primary-600 dark:text-white shadow-sm'
                            : 'text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200'
                            }`}
                    >
