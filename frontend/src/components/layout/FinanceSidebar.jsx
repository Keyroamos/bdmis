    ...
    return (
      ...
      `}>
                ...
                <div className="p-4 space-y-1 overflow-y-auto flex-1 no-scrollbar">
                    ...
                    <SidebarLink icon={Truck} label="Fleet Ops" path="/finance-portal/transport-expenses" onClick={() => handleNavigate('/finance-portal/transport-expenses')} />
                    <SidebarLink icon={Wallet} label="Payroll" path="/finance-portal/salaries" onClick={() => handleNavigate('/finance-portal/salaries')} />
                    <SidebarLink icon={Utensils} label="Cafeteria" path="/finance-portal/food" onClick={() => handleNavigate('/finance-portal/food')} />
                </div>
