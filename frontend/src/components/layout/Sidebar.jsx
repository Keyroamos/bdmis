...
import {
    Users, GraduationCap, DollarSign, Calendar, Settings, LogOut, X, BookOpen, UserCheck, ClipboardCheck, RefreshCw, CreditCard
} from 'lucide-react';
...
const Sidebar = ({ isOpen, onClose, user, onLogout }) => {
    ...
    return (
        <>
            ...
            <aside className={`
        fixed inset-y-0 left-0 z-50 w-72 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 transform transition-transform duration-300 ease-[cubic-bezier(0.23,1,0.32,1)]
      ...
      `}>
                ...
                <div className="p-6 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center">
                    <div className="flex items-center space-x-3">
                        <div className="h-10 w-10 bg-gradient-to-br from-primary-600 to-primary-700 rounded-xl flex items-center justify-center shadow-lg shadow-primary-500/30 text-white overflow-hidden">
                            {config.school_logo ? (
                        ...
                        <div>
                            ...
                            <span className="text-xs text-slate-400 dark:text-slate-500 font-medium tracking-wide uppercase">Admin Portal</span>
                        </div>
                    </div>
